...
const AboutPage = memo((props: AboutPageProps) => {
    ...
    return (
        <Card className={classNames(cls.AboutPage, {}, [className])}>
            ...
            <p>
                ...
                новости кино, интервью с актерами и другими знаменитостями,
                рецензии пользователей, расписание сеансов в кинотеатрах, ТВ-программу и другие разделы.
            </p>
            <p>
